 ...
 * @abstract
 */
abstract class Node extends Dispatcher implements \JSONSerializable
{
    /**
     ...
     * @return void
     */
    public function triggerPropertyChangeEvent($propertyName, $oldValue, $newValue)
    {
        $event = new PropertyChangeEvent($propertyName, $this, ['old' => $oldValue, 'new' => $newValue]);
        $this->trigger(Event::PROPERTY_CHANGE, $event);
    }
